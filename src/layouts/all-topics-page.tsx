...
import PublicTopicsTable from "@/components/public-topics-table";
import { TopicL1 } from "@/components/topic-preview";
import api from "@/util/interceptor";
import { useEffect, useState } from "react";
import Loading from "@/components/loading";
import { getUserTopicColumns } from "@/components/user-topics-columns";
  ...
  return (
    <div className="h-screen font-custom">
      ...
      <section className="p-2 mx-auto mt-2 md:w-[calc(100vw-16rem)] max-w-4xl">
        ...
        <PublicTopicsTable
        data={userTopics}
        columns={getUserTopicColumns({refreshData: fetchTopics})}
        />
      </section>
